...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "border border-slate-200 bg-white text-slate-950 rounded-none shadow-none",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center p-6 pt-0 border-t border-slate-100 pt-6", className)}
    {...props}
  />
));
